...
def add_photos_dialog():
    ...
    if 'photo_tab' not in st.session_state:  # tells if nothig pressed be in camera state not the upload
    ...
    if st.session_state.photo_tab == 'camera':  # here we write the code to disp the camera
